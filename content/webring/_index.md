...
Alternately, use the following code to add links to this webring on your site:

```
<a href="https://webwriterscollective.com/webring/previous/{domain.tld}/">Previous</a>
